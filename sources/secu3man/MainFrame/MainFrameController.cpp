...
void MainFrameController::OnCreate(void)
{
 ...
 m_pLogWriter->SetFieldName(i++, lff.m_fldMapsel0);
 m_pLogWriter->SetFieldName(i++, lff.m_fldRefprs_i);
 m_pLogWriter->SetFieldName(i++, lff.m_fldAltrn_i);
 ...
 m_pLogWriter->SetFieldName(i++, lff.m_fldAFRMap);
 m_pLogWriter->SetFieldName(i++, lff.m_fldTchrg);
 ...
 m_pLogWriter->SetFieldName(i++, lff.m_fldEstTorq);
 m_pLogWriter->SetFieldName(i++, lff.m_fldReqTorq);
