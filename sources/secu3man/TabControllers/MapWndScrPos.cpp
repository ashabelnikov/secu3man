...
void MapWndScrPos::OnCloseMapWnd(HWND i_hwnd, int i_mapType)
{
 ...
 switch(i_mapType)
 {
  ...
  case ETMT_INJ_VE2:
   ...
   break;
  case ETMT_INJ_IVE:
   ws.m_VEIMapWnd_X = rc.left;
   ws.m_VEIMapWnd_Y = rc.top;
   sz.m_VEIMapWnd_W = rc.right - rc.left;
   sz.m_VEIMapWnd_H = rc.bottom - rc.top;
   break;
  case ETMT_INJ_AFR:
  ...
  case ETMT_PWM2:
   ...
   break;
  case ETMT_GME_IGN_WND: //pseudo map
   ...
   break;
  case ETMT_GME_INJ_WND: //pseudo map
  ...
  case ETMT_MANINJPWC:
   ...
   break;
  case ETMT_MAF_CURVE:
   ws.m_MAFCurveMapWnd_X = rc.left;
   ws.m_MAFCurveMapWnd_Y = rc.top;
   sz.m_MAFCurveMapWnd_W = rc.right - rc.left;
   sz.m_MAFCurveMapWnd_H = rc.bottom - rc.top;
   break;
  case ETMT_INJ_TPSZON:
   ws.m_TpszonMapWnd_X = rc.left;
   ws.m_TpszonMapWnd_Y = rc.top;
  ...
  case ETMT_FUELDENS_CORR:
   ws.m_FuelDensCorrMapWnd_X = rc.left;
   ws.m_FuelDensCorrMapWnd_Y = rc.top;
...
void MapWndScrPos::OnOpenMapWnd(HWND i_hwnd, int i_mapType)
{
 ...
 switch(i_mapType)
 {
  ...
  case ETMT_INJ_VE2:
   ...
   break;
  case ETMT_INJ_IVE:
   X = ws.m_VEIMapWnd_X, Y = ws.m_VEIMapWnd_Y;
   W = sz.m_VEIMapWnd_W, H = sz.m_VEIMapWnd_H;
   break;
  case ETMT_INJ_AFR:
  ...
  case ETMT_MANINJPWC:
   ...
   break;
  case ETMT_MAF_CURVE:
   X = ws.m_MAFCurveMapWnd_X, Y = ws.m_MAFCurveMapWnd_Y;
   W = sz.m_MAFCurveMapWnd_W, H = sz.m_MAFCurveMapWnd_H;
   break;
  case ETMT_INJ_TPSZON:
