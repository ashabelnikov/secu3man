...
, m_enable_spiadc(false)
{
 ...
 m_iorem_none = MLL::GetString(IDS_IOREM_NONE);
}
...
void CFWIORemappingController::_PrepareLogic(void)
{
 ...
 { //SECU-3T:
  ...
  m_defValMap.insert(std::make_pair(FWDM::IOS_MAP_S, FWDM::IOP_MAP_S));
  m_defValMap.insert(std::make_pair(FWDM::IOS_ADD_I4, FWDM::IOP_ADD_I4));
  ...
  mp_view->AddItem(FWDM::IOS_IGN_OUT1, FWDM::IOP_IGN_OUT1, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_IGN_OUT2, FWDM::IOP_IGN_OUT2, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_IGN_OUT3, FWDM::IOP_IGN_OUT3, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_IGN_OUT4, FWDM::IOP_IGN_OUT4, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_ADD_IO1, FWDM::IOP_ADD_IO1, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_ADD_IO2, FWDM::IOP_ADD_IO2, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_ECF, FWDM::IOP_ECF, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_ST_BLOCK, FWDM::IOP_ST_BLOCK, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_IE, FWDM::IOP_IE, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_FE, FWDM::IOP_FE, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS_PS, FWDM::IOP_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS_PS, FWDM::IOP_INPUT2, _T("INPUT2"));
  }
  mp_view->AddItem(FWDM::IOS_PS, FWDM::IOP_PS, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_CE, FWDM::IOP_CE, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_BL, FWDM::IOP_BL, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS_DE, FWDM::IOP_DE, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS_ADD_I1, FWDM::IOP_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS_ADD_I1, FWDM::IOP_INPUT2, _T("INPUT2"));
  }
  mp_view->AddItem(FWDM::IOS_ADD_I1, FWDM::IOP_ADD_I1, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS_ADD_I2, FWDM::IOP_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS_ADD_I2, FWDM::IOP_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V39) { 
   mp_view->AddItem(FWDM::IOS_ADD_I2, FWDM::IOP_LAMBDA2, _T("LAMBDA2"));
  }
  mp_view->AddItem(FWDM::IOS_ADD_I2, FWDM::IOP_ADD_I2, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS_REF_S, FWDM::IOP_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS_REF_S, FWDM::IOP_INPUT2, _T("INPUT2"));
  }
  mp_view->AddItem(FWDM::IOS_REF_S, FWDM::IOP_REF_S, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS_GAS_V, FWDM::IOP_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS_GAS_V, FWDM::IOP_INPUT2, _T("INPUT2"));
  }
  mp_view->AddItem(FWDM::IOS_GAS_V, FWDM::IOP_GAS_V, m_iorem_none);
  mp_view->EnableItem(FWDM::IOS_GAS_V, true); 
  mp_view->EnableInversion(FWDM::IOS_GAS_V, true);

  //CKPS
  mp_view->AddItem(FWDM::IOS_CKPS, FWDM::IOP_CKPS, m_iorem_none);
  ...
  //MAP_S
  if (iov >= FWDM::IOV_V36) { 
   mp_view->AddItem(FWDM::IOS_MAP_S, FWDM::IOP_MAF, _T("MAF"));
  }
  mp_view->AddItem(FWDM::IOS_MAP_S, FWDM::IOP_MAP_S, m_iorem_none);
  mp_view->EnableItem(FWDM::IOS_MAP_S, true); 
  mp_view->EnableInversion(FWDM::IOS_MAP_S, false);
  ...
  if (iov >= FWDM::IOV_V39) { 
   ...
   mp_view->AddItem(FWDM::IOS_ADD_I4, FWDM::IOP_MAP2, _T("MAP2"));
  }
  mp_view->AddItem(FWDM::IOS_ADD_I4, FWDM::IOP_ADD_I4, m_iorem_none);
  mp_view->EnableItem(FWDM::IOS_ADD_I4, m_enable_extraio); 
  mp_view->EnableInversion(FWDM::IOS_ADD_I4, m_enable_extraio);
 }
 else
 { //SECU-3i:
  m_defValMap.clear();
  ...
  mp_view->AddItem(FWDM::IOS3I_IGN_O1, FWDM::IOP3I_IGN_O1, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_IGN_O2, FWDM::IOP3I_IGN_O2, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_IGN_O3, FWDM::IOP3I_IGN_O3, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_IGN_O4, FWDM::IOP3I_IGN_O4, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V44) {
  mp_view->AddItem(FWDM::IOS3I_IGN_O5, FWDM::IOP3I_ETC_PWM2, _T("ETC_PWM2"));
  }
  mp_view->AddItem(FWDM::IOS3I_IGN_O5, FWDM::IOP3I_IGN_O5, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V44) {
  mp_view->AddItem(FWDM::IOS3I_ECF, FWDM::IOP3I_ETC_PWM1, _T("ETC_PWM1"));
  }
  mp_view->AddItem(FWDM::IOS3I_ECF, FWDM::IOP3I_ECF, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_INJ_O1, FWDM::IOP3I_INJ_O1, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_INJ_O2, FWDM::IOP3I_INJ_O2, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_INJ_O3, FWDM::IOP3I_INJ_O3, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_INJ_O4, FWDM::IOP3I_INJ_O4, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_INJ_O5, FWDM::IOP3I_INJ_O5, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_BL, FWDM::IOP3I_BL, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_DE, FWDM::IOP3I_DE, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_STBL_O, FWDM::IOP3I_STBL_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_CEL_O, FWDM::IOP3I_CEL_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_FPMP_O, FWDM::IOP3I_FPMP_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_PWRR_O, FWDM::IOP3I_PWRR_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_EVAP_O, FWDM::IOP3I_EVAP_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_O2SH_O, FWDM::IOP3I_O2SH_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_COND_O, FWDM::IOP3I_COND_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_ADD_O2, FWDM::IOP3I_ADD_O2, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_PS, FWDM::IOP3I_PS, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_REF_S, FWDM::IOP3I_REF_S, m_iorem_none);
  mp_view->EnableItem(FWDM::IOS3I_REF_S, true); 
  mp_view->EnableInversion(FWDM::IOS3I_REF_S, true);

  //CKPS
  mp_view->AddItem(FWDM::IOS3I_CKPS, FWDM::IOP3I_CKPS, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V32) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_GRTEMP, _T("GRTEMP"));
  }
  if (iov >= FWDM::IOV_V34) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_FTLS_I, _T("FTLS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_EGTS_I, _T("EGTS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_OPS_I, _T("OPS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_INJPWC_I, _T("INJPWC_I"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  if (iov >= FWDM::IOV_V43) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_FPS, _T("FPS"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I1, FWDM::IOP3I_ADD_I1, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V32) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_GRTEMP, _T("GRTEMP"));
  }
  if (iov >= FWDM::IOV_V34) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_FTLS_I, _T("FTLS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_EGTS_I, _T("EGTS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_OPS_I, _T("OPS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_INJPWC_I, _T("INJPWC_I"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  if (iov >= FWDM::IOV_V43) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_FPS, _T("FPS"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I2, FWDM::IOP3I_ADD_I2, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_ADD_I3, FWDM::IOP3I_MAP2, _T("MAP2"));
  if (iov >= FWDM::IOV_V31) { 
  ...
  if (iov >= FWDM::IOV_V39) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I3, FWDM::IOP3I_LAMBDA2, _T("LAMBDA2"));
  }
  if (iov >= FWDM::IOV_V34) { 
  ...
  if (iov >= FWDM::IOV_V32) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I3, FWDM::IOP3I_GRTEMP, _T("GRTEMP"));
  }
  if (iov >= FWDM::IOV_V34) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I3, FWDM::IOP3I_OPS_I, _T("OPS_I"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I3, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I3, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I3, FWDM::IOP3I_ADD_I3, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_TMP2, _T("TEMP2"));
  if (iov >= FWDM::IOV_V31) { 
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V36) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_MAF, _T("MAF"));
  }
  if (iov >= FWDM::IOV_V39) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_LAMBDA, _T("LAMBDA"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_LAMBDA2, _T("LAMBDA2"));
  }
  if (iov >= FWDM::IOV_V41) {
  ...
  if (iov >= FWDM::IOV_V32) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_GRTEMP, _T("GRTEMP"));
  }
  if (iov >= FWDM::IOV_V34) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_OPS_I, _T("OPS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_FTLS_I, _T("FTLS_I"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I4, FWDM::IOP3I_ADD_I4, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_GAS_V, FWDM::IOP3I_GAS_V, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_IGN_I, FWDM::IOP3I_IGN_I, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_COND_I, FWDM::IOP3I_COND_I, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_EPAS_I, FWDM::IOP3I_EPAS_I, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_TACH_O, FWDM::IOP3I_TACH_O, m_iorem_none);
  ...
  mp_view->AddItem(FWDM::IOS3I_KSP_CS, FWDM::IOP3I_KSP_CS, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V32) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_GRTEMP, _T("GRTEMP"));
  }
  if (iov >= FWDM::IOV_V33) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_TMP2, _T("TEMP2"));
  ...
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V36) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_MAF, _T("MAF"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  if (iov >= FWDM::IOV_V39) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_LAMBDA, _T("LAMBDA"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_LAMBDA2, _T("LAMBDA2"));
  }
  if (iov >= FWDM::IOV_V41) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_GPS, _T("GPS"));
  }
  if (iov >= FWDM::IOV_V42) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_ALTRN_I, _T("ALTRN_I"));
  }
  if (iov >= FWDM::IOV_V43) {
  ...
  if (iov >= FWDM::IOV_V44) {
   ...
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_APPS1, _T("APPS1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_APPS2, _T("APPS2"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I5, FWDM::IOP3I_ADD_I5, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V33) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_TMP2, _T("TEMP2"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_MAP2, _T("MAP2"));
  }
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V36) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_MAF, _T("MAF"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  if (iov >= FWDM::IOV_V39) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_LAMBDA, _T("LAMBDA"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_LAMBDA2, _T("LAMBDA2"));
  }
  if (iov >= FWDM::IOV_V41) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_GPS, _T("GPS"));
  }
  if (iov >= FWDM::IOV_V42) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_ALTRN_I, _T("ALTRN_I"));
  }
  if (iov >= FWDM::IOV_V43) {
  ...
  if (iov >= FWDM::IOV_V44) {
   ...
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_APPS1, _T("APPS1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_APPS2, _T("APPS2"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I6, FWDM::IOP3I_ADD_I6, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V32) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_GRTEMP, _T("GRTEMP"));
  }
  if (iov >= FWDM::IOV_V33) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_TMP2, _T("TEMP2"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_MAP2, _T("MAP2"));
  }
  if (iov >= FWDM::IOV_V34) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_FTLS_I, _T("FTLS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_EGTS_I, _T("EGTS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_OPS_I, _T("OPS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_INJPWC_I, _T("INJPWC_I"));
  }
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V36) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_MAF, _T("MAF"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  if (iov >= FWDM::IOV_V39) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_LAMBDA, _T("LAMBDA"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_LAMBDA2, _T("LAMBDA2"));
  }
  if (iov >= FWDM::IOV_V41) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_GPS, _T("GPS"));
  }
  if (iov >= FWDM::IOV_V42) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_ALTRN_I, _T("ALTRN_I"));
  }
  if (iov >= FWDM::IOV_V43) {
  ...
  if (iov >= FWDM::IOV_V44) {
   ...
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_APPS1, _T("APPS1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_APPS2, _T("APPS2"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I7, FWDM::IOP3I_ADD_I7, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V32) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_GRTEMP, _T("GRTEMP"));
  }
  if (iov >= FWDM::IOV_V33) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_TMP2, _T("TEMP2"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_MAP2, _T("MAP2"));
  }
  if (iov >= FWDM::IOV_V34) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_FTLS_I, _T("FTLS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_EGTS_I, _T("EGTS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_OPS_I, _T("OPS_I"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_INJPWC_I, _T("INJPWC_I"));
  }
  if (iov >= FWDM::IOV_V35) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_INPUT1, _T("INPUT1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_INPUT2, _T("INPUT2"));
  }
  if (iov >= FWDM::IOV_V36) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_MAF, _T("MAF"));
  }
  if (iov >= FWDM::IOV_V38) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_FTS_I, _T("FTS_I"));
  }
  if (iov >= FWDM::IOV_V39) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_LAMBDA, _T("LAMBDA"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_LAMBDA2, _T("LAMBDA2"));
  }
  if (iov >= FWDM::IOV_V41) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_GPS, _T("GPS"));
  }
  if (iov >= FWDM::IOV_V42) {
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_ALTRN_I, _T("ALTRN_I"));
  }
  if (iov >= FWDM::IOV_V43) {
  ...
  if (iov >= FWDM::IOV_V44) {
   ...
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_APPS1, _T("APPS1"));
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_APPS2, _T("APPS2"));
  }
  if (iov >= FWDM::IOV_V45) { 
   mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_OTS_I, _T("OTS_I"));
  }
  mp_view->AddItem(FWDM::IOS3I_ADD_I8, FWDM::IOP3I_ADD_I8, m_iorem_none);
  ...
  //MAP_I
  if (iov >= FWDM::IOV_V36) { 
   mp_view->AddItem(FWDM::IOS3I_MAP_I, FWDM::IOP3I_MAF, _T("MAF"));
  }
  mp_view->AddItem(FWDM::IOS3I_MAP_I, FWDM::IOP3I_MAP_I, m_iorem_none);
  ...
  if (iov >= FWDM::IOV_V42) {
   mp_view->AddItem(FWDM::IOS3I_GPA4_I, FWDM::IOP3I_ALTRN_I, _T("ALTRN_I"));
  }
  mp_view->AddItem(FWDM::IOS3I_GPA4_I, FWDM::IOP3I_GPA4_I, m_iorem_none);
 ...
 mp_view->AddItem(FWDM::IOS3I_GPA6_O, FWDM::IOP3I_GPA6_O, m_iorem_none);
...
bool CFWIORemappingController::_IsIOPInput(FWDM::IOPid iopId) const
{
 if (m_enable_secu3t_features)
  return (iopId == FWDM::IOP_PS || iopId == FWDM::IOP_ADD_I1 || iopId == FWDM::IOP_ADD_I2 || iopId == FWDM::IOP_IGN || iopId == FWDM::IOP_BC_INPUT ||
          ...
          iopId == FWDM::IOP_AIR_TEMP || iopId == FWDM::IOP_CKPS || iopId == FWDM::IOP_COND_I || iopId == FWDM::IOP_AUTO_I || iopId == FWDM::IOP_INPUT1 ||
          iopId == FWDM::IOP_INPUT2 || iopId == FWDM::IOP_MAP_S || iopId == FWDM::IOP_MAF || iopId == FWDM::IOP_LAMBDA2 || iopId == FWDM::IOP_ADD_I4 || 
          iopId == FWDM::IOP_IGNTIM || iopId == FWDM::IOP_MAP2);
 else //SECU-3i:
  return (iopId == FWDM::IOP3I_PS || iopId == FWDM::IOP3I_ADD_I1 || iopId == FWDM::IOP3I_ADD_I2 || iopId == FWDM::IOP3I_IGN_I || iopId == FWDM::IOP3I_BC_INPUT ||
          ...
          iopId == FWDM::IOP3I_LAMBDA2 || iopId == FWDM::IOP3I_GPA4_I || iopId == FWDM::IOP3I_GPS || iopId == FWDM::IOP3I_ALTRN_I || iopId == FWDM::IOP3I_FPS ||
          iopId == FWDM::IOP3I_TPS2 || iopId == FWDM::IOP3I_APPS1 || iopId == FWDM::IOP3I_APPS2 || iopId == FWDM::IOP3I_OTS_I);
}
...
void CFWIORemappingController::_DisplayPlugs(void)
{
 ...
 names.insert(std::make_pair(FWDM::IOS_MAP_S, _T("MAP_S")));
 names.insert(std::make_pair(FWDM::IOS_ADD_I4, _T("ADD_I4")));
