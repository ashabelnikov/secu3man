...
void CLogPlayerTabController::ConfigureIndicators(void)
{
 ...
 mp_view->mp_MIDeskDlg->SetMetersCfg(cfg1[idx].m_optMetRows, cfg1[idx].m_optMetRPM, cfg1[idx].m_optMetMAP, cfg1[idx].m_optMetVBat, cfg1[idx].m_optMetIgnTim, cfg1[idx].m_optMetCLT, cfg1[idx].m_optMetAddI1, cfg1[idx].m_optMetAddI2,
  ...
  cfg1[idx].m_optMetInjTimB, cfg1[idx].m_optMetInjTimE, cfg1[idx].m_optMetFuelConsumF, cfg1[idx].m_optMetGrts,  cfg1[idx].m_optMetFtls, cfg1[idx].m_optMetEgts, cfg1[idx].m_optMetOps, cfg1[idx].m_optMetInjDuty, cfg1[idx].m_optMetMAF, cfg1[idx].m_optMetVentDuty, cfg1[idx].m_optMetMAPDot,
...
void CLogPlayerTabController::OnMIDeskSettingsChanged(void)
{
 ...
 IndCoolingFan, IndCE, IndFCRevLim, IndFloodClear, IndSysLocked, IndIgn_i, IndCond_i, IndEpas_i, IndAftStrEnr, IndIacClLoop, IndUniOut1, IndUniOut2, IndUniOut3, IndUniOut4, IndUniOut5, IndUniOut6;
 ...
 mp_view->mp_MIDeskDlg->GetMetersCfg(cfg1[idx].m_optMetRows, cfg1[idx].m_optMetRPM, cfg1[idx].m_optMetMAP, cfg1[idx].m_optMetVBat, cfg1[idx].m_optMetIgnTim, cfg1[idx].m_optMetCLT, cfg1[idx].m_optMetAddI1, cfg1[idx].m_optMetAddI2,
  ...
  cfg1[idx].m_optMetGDPos, cfg1[idx].m_optMetSynLoad, cfg1[idx].m_optMetInjTimB, cfg1[idx].m_optMetInjTimE, cfg1[idx].m_optMetFuelConsumF, cfg1[idx].m_optMetGrts, cfg1[idx].m_optMetFtls, cfg1[idx].m_optMetEgts, cfg1[idx].m_optMetOps, cfg1[idx].m_optMetMAF, cfg1[idx].m_optMetVentDuty, cfg1[idx].m_optMetMAPDot,
