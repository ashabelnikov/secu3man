...
void CLogPlayerTabController::OnMIDeskSettingsChanged(void)
{
 ...
 IndCoolingFan, IndCE, IndFCRevLim, IndFloodClear, IndSysLocked, IndIgn_i, IndCond_i, IndEpas_i, IndAftStrEnr, IndIacClLoop;

 mp_view->mp_MIDeskDlg->GetIndicatorsCfg(IndHeightPercent, IndRows, IndGas_v, IndCarb, IndIdleValve, IndPowerValve, IndStBlock, IndAE, IndCoolingFan, IndCE, IndFCRevLim, IndFloodClear, IndSysLocked, IndIgn_i, IndCond_i, IndEpas_i, IndAftStrEnr, IndIacClLoop);
