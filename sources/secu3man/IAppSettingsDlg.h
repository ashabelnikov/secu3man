...
public:
   ...
   virtual void FillCtrlsWithAllowablePorts(std::vector<std::wstring> i_AllowablePorts) = 0;

   //"Set" - установка данных представления
   virtual void SetPortName(std::wstring i_PortName) = 0;
   ...
   virtual std::wstring GetPortName(void) = 0;
