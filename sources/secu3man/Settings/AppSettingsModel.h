...
class CAppSettingsModel : public ISettingsData
{
 ...
 public:
  ...
  virtual int GetGraphValueHeight(void);
 ...
 private:
  ...
  OptField_t<int>  m_optTorqueAverage;
  ...
  OptField_t<POINT> m_optVEIMapWnd;
  ...
  OptField_t<POINT> m_optFuelDensCorrMapWnd;
  OptField_t<POINT> m_optXtauXfAccMapWnd;
  ...
  OptField_t<POINT> m_optEstimTorqueMapWnd;
  OptField_t<POINT> m_optFlcutTorqueMapWnd;
  OptField_t<POINT> m_optDtorqItCorrMapWnd;
  ...
  OptField_t<POINT> m_optVEIMapWnd1;
  ...
  OptField_t<POINT> m_optEstimTorqueMapWnd1;
  OptField_t<POINT> m_optFlcutTorqueMapWnd1;
  OptField_t<POINT> m_optDtorqItCorrMapWnd1;
  ...
  OptField_t<POINT> m_optVEIMapWndSize;
  ...
  OptField_t<POINT> m_optFuelDensCorrMapWndSize;
  OptField_t<POINT> m_optXtauXfAccMapWndSize;
  ...
  OptField_t<POINT> m_optEstimTorqueMapWndSize;
  OptField_t<POINT> m_optFlcutTorqueMapWndSize;
  OptField_t<POINT> m_optDtorqItCorrMapWndSize;
  ...
  OptField_t<POINT> m_optVEIMapWndSize1;
  ...
  OptField_t<POINT> m_optEstimTorqueMapWndSize1;
  OptField_t<POINT> m_optFlcutTorqueMapWndSize1;
  OptField_t<POINT> m_optDtorqItCorrMapWndSize1;
  ...
  OptField_t<int> m_optIndGpa4_i[2];
  ...
  OptField_t<int> m_optIndRefprs_i[2];
  OptField_t<int> m_optIndAltrn_i[2];
  ...
  OptField_t<int> m_optMetTorque[2][2];

  //meters scales' options
  OptField_t<SclCfg> m_optMetScRPM[2];
  OptField_t<SclCfg> m_optMetScMAP[2];
  OptField_t<SclCfg> m_optMetScVBat[2];
  OptField_t<SclCfg> m_optMetScIgnTim[2];
  OptField_t<SclCfg> m_optMetScCLT[2];
  OptField_t<SclCfg> m_optMetScAddI1[2];
  OptField_t<SclCfg> m_optMetScAddI2[2];
  OptField_t<SclCfg> m_optMetScInjPW[2];
  OptField_t<SclCfg> m_optMetScIAT[2];
  OptField_t<SclCfg> m_optMetScEGOCorr[2];
  OptField_t<SclCfg> m_optMetScTPS[2];
  OptField_t<SclCfg> m_optMetScAirFlow[2];
  OptField_t<SclCfg> m_optMetScVehicleSpeed[2];
  OptField_t<SclCfg> m_optMetScTPSDot[2];
  OptField_t<SclCfg> m_optMetScMAPDot[2];
  OptField_t<SclCfg> m_optMetScMAP2[2];
  OptField_t<SclCfg> m_optMetScGPS[2];
  OptField_t<SclCfg> m_optMetScMAPD[2];
  OptField_t<SclCfg> m_optMetScTmp2[2];
  OptField_t<SclCfg> m_optMetScFuelConsum[2];
  OptField_t<SclCfg> m_optMetScKnockRetard[2];
  OptField_t<SclCfg> m_optMetScKnockGraph[2];
  OptField_t<SclCfg> m_optMetScSensAFR[2];
  OptField_t<SclCfg> m_optMetScChokePos[2];
  OptField_t<SclCfg> m_optMetScGDPos[2];
  OptField_t<SclCfg> m_optMetScSynLoad[2];
  OptField_t<SclCfg> m_optMetScInjTimB[2]; //0...720
  OptField_t<SclCfg> m_optMetScInjTimE[2]; //0...720
  OptField_t<SclCfg> m_optMetScInjTimB1[2];//-360...360
  OptField_t<SclCfg> m_optMetScInjTimE1[2];//-360...360
  OptField_t<SclCfg> m_optMetScFuelConsumF[2];
  OptField_t<SclCfg> m_optMetScGrts[2];
  OptField_t<SclCfg> m_optMetScFtls[2];
  OptField_t<SclCfg> m_optMetScEgts[2];
  OptField_t<SclCfg> m_optMetScOps[2];
  OptField_t<SclCfg> m_optMetScInjDuty[2];
  OptField_t<SclCfg> m_optMetScMAF[2];
  OptField_t<SclCfg> m_optMetScVentDuty[2];
  OptField_t<SclCfg> m_optMetScFts[2];
  OptField_t<SclCfg> m_optMetScEGOCorr2[2];
  OptField_t<SclCfg> m_optMetScSensAFR2[2];
  OptField_t<SclCfg> m_optMetScTargAFR[2];
  ...
  OptField_t<SclCfg> m_optMetScTorque[2];
  ...
  OptField_t<COLORREF> m_optColGpa4_i;
  ...
  OptField_t<COLORREF> m_optColRefprs_i;
  OptField_t<COLORREF> m_optColAltrn_i;
  ...
  OptField_t<float> m_optPtMovStepVeiMap;
  ...
  OptField_t<float> m_optPtMovStepCylMultMap;
  OptField_t<float> m_optPtMovStepCylAddMap;
  //separate
  ...
  OptField_t<float> m_optPtMovStepFuelDensCorrMap;
  OptField_t<float> m_optPtMovStepXtauXfAccMap;
  ...
  OptField_t<float> m_optPtMovStepEstimTorqueMap;
  OptField_t<float> m_optPtMovStepFlcutTorqueMap;
  OptField_t<float> m_optPtMovStepDtorqItCorrMap;
  ...
  OptField_t<_TSTRING> m_optLogFieldGpa4_i;
  ...
  OptField_t<_TSTRING> m_optLogFieldRefprs_i;
  OptField_t<_TSTRING> m_optLogFieldAltrn_i;
  ...
  OptField_t<_TSTRING> m_optLogFieldEstTorq;
  OptField_t<_TSTRING> m_optLogFieldReqTorq;
  ...
  OptField_t<bool> m_optFuncAMT_SUPPORT;
