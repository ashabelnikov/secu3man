...
bool CAppSettingsModel::ReadSettings(void)
{
 ...
 const TCHAR* metScDef[2][47] = {
                             //Width, gridColor, ticksNum, Min, Max, PieRadius, Start, End, Color...
                             {_T("1, 000000, 16, 0, 8000, 20, 0,4000,64FF64, 4000,6000,FFFF64, 6000,8000,FF6464"),  //RPM
                              _T("1, 000000, 20, 10, 110, 20, 10,30,B48282, 30,90,78C878, 90,110,B48282"),          //MAP
                              _T("1, 000000, 16, 2,  18,  20, 2.0,10.0,FF8080, 10.0,15.0,80FF80, 15.0,18.0,FF0000"), //Vbat
                              _T("1, 000000, 16,-15, 65,  20, -15.0,0.0,B48282, 0.0,45.0,DCDC78, 45.0,65.0,FF6464"), //Ign.tim.
                              _T("1, 000000, 16, 0,  100, 20, 0,5,8282B4, 5,75,78B496, 75,100,E68282"),             //TPS
                              _T("1, 000000, 16,-40, 120, 20, -40,50,8282B4, 50,100,787878, 100,120,E68282"),       //CLT
                              _T("1, 000000, 20, 0,  5,   20, 0,5,B4B4E6"), //ADD_I1
                              _T("1, 000000, 20, 0,  5,   20, 0,5,B4B4E6"), //ADD_I2
                              _T("1, 000000, 24, 0,  24,  20, 0,1,FF6464, 1,10,64FF64, 10,24,9696FA"), //Inj.PW
                              _T("1, 000000, 16,-40, 120, 20, -40,50,8282B4, 50,100,787878, 100,120,E68282"), //IAT
                              _T("1, 000000, 16,-50, 50,  20, -50,-20,E68282, -20,20,78BE78, 20,50,E68282"),  //EGO corr.
                              _T("1, 000000, 16, 0,  16,  20, 0,1,BE9696, 1,2,B496A0, 2,3,AA96AA, 3,4,A096B4, 4,5,9696BE, 5,6,9696C8, 6,7,9696D2, 7,8,9696DC, 8,9,9696E6, 9,10,9696F0, 10,11,9696FA, 11,12,9696FF, 12,13,9696FF, 13,14,9696FF, 14,15,9696FF, 15,16,9696FF"),  //AirFlow
                              _T("1, 000000, 22, 0,  220, 20, 0,60,64FF64, 60,120,FAE664, 120,180,E68264, 180,220,FF7878"), //Vehicle seed
                              _T("1, 000000, 10,-500,500, 20, -500,-200,FA6464, -200,-50,64FA64, -50,0,6464FA, 0,50,6464FA, 50,200,64FA64, 200,500,FA6464"), //TPSdot
                              _T("1, 000000, 10,-500,500, 20, -500,-200,FA6464, -200,-50,64FA64, -50,0,6464FA, 0,50,6464FA, 50,200,64FA64, 200,500,FA6464 "), //MAPdot
                              _T("1, 000000, 20, 0,  400, 20, 0,100,B48282, 100,400,78C878"), //MAP2
                              _T("1, 000000, 20, 0,  400, 20, 0,100,B48282, 100,400,78C878"), //MAPD
                              _T("1, 000000, 16,-40, 120, 20, -40,50,8282B4, 50,100,787878, 100,120,E68282"), //TEMP2
                              _T("1, 000000, 25, 0,  50,  20, 0,10,64DC64, 10,20,B4B464, 20,50,DC6464"),  //FuelConsum
                              _T("1, 000000, 15, 0,  30,  20, 0,10,DCDC78, 10,30,DC7878"),  //KnockRetard
                              _T("1, 000000, 21, 0,  5,   20, 0,0.5,2850DC, 0.5,1.0,3C64B4, 1.0,1.5,5078A0, 1.5,2.0,648C8C, 2.0,2.5,78A078, 2.5,3.0,8CB464, 3.0,3.5,A0A064, 3.5,4.0,B48C64, 4.0,4.5,C87864, 4.5,5.0,E66464"),   //Knock signal
                              _T("1, 000000, 18, 6,  24,  20, 6,10,FF8282, 10,14.55,F0F082, 14.55,14.85,82FF82, 14.85,15.45,F0F078, 15.45,15.75,82FF82, 15.75,20,F0F082, 20,24,FF8282"),  //Sens AFR
                              _T("1, 000000, 20, 0,  100, 20, 0,100,00E6FA"), //Choke pos.
                              _T("1, 000000, 20, 0,  100, 20, 0,100,00E6FA"), //GD pos.
                              _T("1, 000000, 20, 0,  250, 20, 0,100,82FA82, 100,250,FA8282"), //SynLoad
                              _T("1, 000000, 16, 0,  720, 20, 0,720,FAFAFA"), //InjTimB
                              _T("1, 000000, 16, 0,  720, 20, 0,720,FAFAFA"), //InjTimE
                              _T("1, 000000, 16,-360,360, 20, -360,360,FAFAFA"), //InjTimB1
                              _T("1, 000000, 16,-360,360, 20, -360,360,FAFAFA"), //InjTimE1
                              _T("1, 000000, 20, 0,  250, 20, 0,10,828296, 10,70,64F064, 70,150,E6E664, 150,250,F06464"), //FuelConsumF
                              _T("1, 000000, 16,-40, 120, 20, -40,50,8282B4, 50,100,787878, 100,120,E68282"), //GRTS
                              _T("1, 000000, 20, 0,  100, 20, 0,10,FA6464, 10,50,DCDC64, 50,100,64DC64"), //FTLS
                              _T("1, 000000, 16, 0, 1100, 20, 0,400,6464FF, 400,950,C8C878, 950,1100,FF6464"), //EGTS
                              _T("1, 000000, 12, 0,  6,   20, 0,1,8282BE, 1,3.5,78F078, 3.5,5.0,F0F078, 5.0,6.0,FF8282"),   //OPS
                              _T("1, 000000, 21, 0,  100, 20, 0,10,6464FF, 10,70,64FF64, 70,90,F0FF64, 90,100,FF6464"), //InjDuty
                              _T("1, 000000, 20, 0,  600, 20, 0,100,8282B4, 100,300,78C878, 300,500,C8C878, 500,600,C87878"), //MAF
                              _T("1, 000000, 21, 0,  100, 20, 0,10,6464FF, 10,70,64FF64, 70,90,F0FF64, 90,100,FF6464"), //VentDuty
                              _T("1, 000000, 16,-40, 120, 20, -40,50,8282B4, 50,100,787878, 100,120,E68282"), //FTS
                              _T("1, 000000, 16,-50, 50,  20, -50,-20,E68282, -20,20,78BE78, 20,50,E68282"),  //EGO Corr.2
                              _T("1, 000000, 18, 6,  24,  20, 6,10,FF8282, 10,14.55,F0F082, 14.55,14.85,82FF82, 14.85,15.45,F0F078, 15.45,15.75,82FF82, 15.75,20,F0F082, 20,24,FF8282"),  //Sens AFR2
                              _T("1, 000000, 18, 6,  24,  20, 6,10,FF8282, 10,14.55,F0F082, 14.55,14.85,82FF82, 14.85,15.45,F0F078, 15.45,15.75,82FF82, 15.75,20,F0F082, 20,24,FF8282"),  //TargAFR
                              _T("1, 000000, 18,-10, 10,  20, -9,-2,8282FF, -2,-1,F0F082, -1,1,82FF82, 1,2,F0F082, 2,9,FF8282"),  //DiffAFR
                              _T("1, 000000, 18,-10, 10,  20, -9,-2,8282FF, -2,-1,F0F082, -1,1,82FF82, 1,2,F0F082, 2,9,FF8282"),  //DiffAFR2
                              _T("1, 000000, 20, 0,  400, 20, 0,100,B48282, 100,400,78C878"), //GPS
                              _T("1, 000000, 20, 0,  700, 20, 0,300,B48282, 300,700,78C878"),//FPS
                              _T("1, 000000, 16, 0,  100, 20, 0,10,B6B6D3,10,90,93EA79,90,100,FB5537"), //APPS
                              _T("1, 000000, 16,-40, 140, 20, -40,50,8282B4, 50,100,787878, 100,140,E68282")}, //OTS
                             //graphs:
