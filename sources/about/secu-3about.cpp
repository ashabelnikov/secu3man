...
*/ 
 ...
 BYTE hash1[32] = {0x92,0xab,0x9a,0x54,0x32,0xe4,0x4f,0x01,0xa5,0x81,0x62,0xb7,0xd7,0x01,0x37,0x03,0x54,0xba,0x78,0xea,0x78,0xfa,0xe2,0x93,0x29,0x95,0x4e,0x10,0x51,0x66,0xa3,0x93}; //ru
 BYTE hash2[32] = {0x5d,0x8d,0x83,0xa1,0xb3,0x38,0xe0,0x9a,0xab,0x7b,0xb3,0x43,0x3d,0x7d,0x86,0x56,0x2a,0xbd,0x7b,0xb0,0xf3,0xf5,0x02,0xdb,0xeb,0x23,0x7c,0x89,0x49,0x65,0x4b,0x7d}; //en
...
bool ABOUT_API CheckAbout(void)
{
 ...
 BYTE hash1[32] = {0xD1,0xCC,0x9B,0x2C,0xE1,0x05,0x35,0x22,0x22,0x08,0x07,0x85,0x04,0xE7,0x3E,0x0D,0x55,0x61,0x86,0xB7,0x65,0x80,0xFD,0x26,0x32,0xAE,0xF7,0x89,0x3D,0xE9,0x47,0x46};
 BYTE digest[SHA256_BLOCK_SIZE];
 Sha256 sha;
 sha.init();
 sha.update((BYTE*)str.c_str(), str.size());
...
{//hashes for 4.7 version info
#ifdef SECU3NOPROTECTION
 return true;
#else

 BYTE hash1[SHA256_BLOCK_SIZE] = {0xA2,0x93,0xC5,0xE0,0x5A,0x53,0x6A,0xCA,0xC0,0x08,0x0C,0xF5,0xA4,0x61,0xCA,0x1A,0x24,0xEA,0x3E,0xDC,0x87,0xD2,0x87,0xE2,0x2B,0xE5,0x72,0x94,0x87,0x0A,0x0F,0x1E};
 BYTE hash2[SHA256_BLOCK_SIZE] = {0xD7,0x21,0xE1,0x1A,0xCC,0xCD,0x0E,0xED,0x62,0x7E,0x5A,0x5C,0xF7,0xD5,0xE8,0x32,0xC1,0xA4,0xAC,0x3F,0x56,0x2A,0xAE,0xB6,0xEE,0x4F,0x5F,0x76,0xD5,0xA2,0xA5,0x54};
 BYTE hash3[SHA256_BLOCK_SIZE] = {0xF2,0xBA,0xC7,0x78,0x81,0x78,0x83,0x3E,0xDD,0x19,0xDE,0x27,0xC4,0x72,0xD2,0x2D,0x1B,0x6D,0xEB,0x14,0x2D,0xF9,0x80,0xD4,0x2C,0x33,0x2B,0xE0,0x27,0x84,0xA0,0xF7};//{0x09,0x5D,0x46,0x2D,0xCD,0xA3,0x55,0xD3,0x76,0x7A,0x57,0xDF,0xEC,0x40,0xD2,0x37,0xEE,0xE4,0xCF,0x37,0x42,0x7B,0x1A,0xA2,0x21,0xD8,0xA0,0xA3,0x20,0x28,0xFF,0x97};
 BYTE hash4[SHA256_BLOCK_SIZE] = {0x8A,0x36,0xB3,0x15,0x72,0x60,0xB9,0x50,0x3F,0x48,0x7C,0xE2,0x0D,0xED,0x35,0xAF,0xDF,0xE4,0x73,0xAC,0x28,0x63,0xF1,0x7C,0x9D,0x48,0xC8,0x4C,0xE6,0x8D,0xE6,0x27};
