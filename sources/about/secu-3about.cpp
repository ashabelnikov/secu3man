...
bool ABOUT_API CheckAbout(void)
{
 ...
 BYTE hash1[32] = {0xD0,0xEB,0xFA,0x04,0xF3,0x4D,0xD3,0x84,0xE5,0x2C,0x5E,0x86,0x6D,0x52,0xE8,0x51,0x7B,0x79,0x6A,0xCB,0xDF,0x52,0x61,0xA0,0x6E,0xD3,0xD6,0x32,0x4C,0xB1,0xAA,0xA2};
 BYTE digest[SHA256_BLOCK_SIZE];
 Sha256 sha;
 sha.init();
 sha.update((BYTE*)str.c_str(), str.size());
...
{//hashes for 4.9 version info
 ...
 BYTE hash3[SHA256_BLOCK_SIZE] = {0x1E,0x51,0xB0,0x0E,0x1A,0x8D,0xE0,0x60,0x59,0x88,0x9E,0x64,0x9A,0x5F,0x8B,0xD8,0x36,0x83,0xFD,0x7A,0x98,0xC6,0x48,0xBD,0x52,0x06,0xCA,0xDF,0x14,0x00,0x91,0x3E};
 BYTE hash4[SHA256_BLOCK_SIZE] = {0x49,0xB7,0x90,0x40,0xA8,0xA3,0x78,0x35,0x92,0x96,0x28,0x87,0xCC,0x6D,0x39,0x68,0x9E,0x3A,0x15,0x28,0xCB,0x71,0x36,0x7F,0x7D,0x81,0x89,0xF2,0xB7,0x99,0x0B,0xB2};
