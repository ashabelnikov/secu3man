...
bool ABOUT_API CheckAbout(void)
{
 ...
 BYTE hash1[32] = {0x9B,0xF0,0xEC,0x29,0xD2,0x43,0xFE,0x3F,0x01,0xF3,0x41,0x0F,0x40,0xB9,0x63,0xAF,0xA2,0x41,0x5E,0xDF,0x27,0xAE,0x58,0xEA,0x38,0x26,0x09,0x09,0x08,0x17,0xF6,0xAA};
 BYTE digest[SHA256_BLOCK_SIZE];
 Sha256 sha;
 sha.init();
 sha.update((BYTE*)str.c_str(), str.size());
