...
bool CheckAppTitle(CWnd* p_wnd)
{
 ...
 //"SECU-3 Manager v4.9"
 BYTE hash_title[SHA256_BLOCK_SIZE] = {0xEF,0x69,0x3D,0x44,0xE7,0xEB,0xF2,0xED,0xA0,0xFD,0xBB,0x7B,0x58,0xCE,0x56,0xA4,0xD8,0x8C,0x5A,0x4F,0xFB,0xF6,0xA3,0x8E,0x93,0x40,0xD8,0xBD,0xCB,0x5E,0xEE,0x07};
 sha.init();
...
*/ 
 ...
 BYTE hash1[32] = {0x81,0xA7,0xEC,0x49,0x05,0x28,0x96,0x31,0x2E,0xC2,0xC3,0xD7,0x81,0x4A,0x69,0xF2,0x7A,0xEC,0xA0,0xF8,0x8C,0x8F,0xB7,0xD2,0xB7,0xCC,0x71,0x77,0xAE,0x1C,0x9A,0x35}; //ru
 BYTE hash2[32] = {0xD7,0x9D,0x47,0xB7,0x4B,0xE9,0xC9,0x22,0x4E,0xD5,0x0D,0x00,0x2B,0x16,0x3E,0x46,0xD7,0x31,0x93,0x00,0xD2,0xC8,0xFB,0x35,0x4B,0xA0,0x64,0x9A,0xBA,0x07,0x86,0xAD}; //en
...
bool ABOUT_API CheckAbout(void)
{
 ...
 BYTE hash1[32] = {0x6C,0x96,0xF2,0xF6,0xDA,0xE9,0x22,0xED,0x2D,0x96,0x20,0x77,0x79,0x36,0x36,0xDE,0x67,0xA5,0x66,0x1E,0x66,0x35,0xFE,0x9B,0x6D,0xC9,0x3E,0xAD,0x29,0xC2,0x2E,0x34};
 BYTE digest[SHA256_BLOCK_SIZE];
 Sha256 sha;
 sha.init();
 sha.update((BYTE*)str.c_str(), str.size());
...
{//hashes for 4.9 version info
#ifdef SECU3NOPROTECTION
 return true;
#else

 BYTE hash1[SHA256_BLOCK_SIZE] = {0xB0,0x3D,0x1F,0xDE,0x10,0x17,0x2F,0x4A,0xD6,0x01,0x49,0xD2,0x77,0x8E,0xB4,0x14,0x2E,0x54,0xe5,0x2A,0x68,0x7B,0x1F,0xE9,0x18,0xFF,0xF8,0x48,0x56,0xAB,0x7C,0xD1};
 BYTE hash2[SHA256_BLOCK_SIZE] = {0x17,0xCE,0x19,0xAE,0xB8,0x64,0x82,0x10,0xF0,0x93,0xB0,0xFB,0x18,0x8E,0xF0,0xB6,0xA7,0x44,0x18,0x3D,0xAA,0xE3,0xC8,0x58,0xE2,0x3E,0x84,0x18,0x06,0xf5,0x8B,0xD8};
 BYTE hash3[SHA256_BLOCK_SIZE] = {0xBE,0x71,0xDA,0xC4,0xA8,0x3F,0x3D,0x31,0x20,0x9E,0x4D,0x32,0xCC,0x04,0x17,0xEB,0x99,0x5F,0xF3,0x74,0x50,0x8A,0xB0,0x9D,0xDA,0xDB,0x4A,0x29,0x4F,0x88,0x5C,0x22};
 BYTE hash4[SHA256_BLOCK_SIZE] = {0xF9,0xB4,0x7C,0x75,0x9A,0xA4,0xE8,0x64,0x75,0x4E,0x44,0x7B,0x42,0x7D,0x35,0x3F,0x1D,0xEC,0x56,0x15,0x28,0x0E,0x35,0x43,0x5C,0x85,0x9D,0x25,0xAB,0xE6,0x15,0xF1};
