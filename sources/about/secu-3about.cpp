...
*/ 
 ...
 BYTE hash1[32] = {0xD1,0x74,0x6C,0x39,0xB1,0x4D,0xC0,0xDE,0x5F,0x38,0x80,0x42,0xA0,0xA9,0xC9,0xD3,0x8E,0xE8,0x37,0x86,0x00,0xD4,0x1B,0xF4,0x33,0x75,0xA7,0xB6,0x04,0x81,0x0A,0x54}; //ru
...
bool ABOUT_API CheckAbout(void)
{
 ...
 BYTE hash1[32] = {0xBD,0x4D,0x62,0xE8,0x37,0xF4,0x17,0x37,0xA1,0xB1,0xB8,0xD1,0xBB,0xF5,0x37,0x1C,0xC8,0xAC,0x1E,0x99,0x63,0x73,0x51,0xAC,0x75,0xE6,0x15,0x71,0x4A,0x89,0xD1,0x34};
 BYTE digest[SHA256_BLOCK_SIZE];
 Sha256 sha;
 sha.init();
 sha.update((BYTE*)str.c_str(), str.size());
...
{//hashes for 4.9 version info
 ...
 BYTE hash1[SHA256_BLOCK_SIZE] = {0xD6,0xA6,0x6C,0x0A,0x6B,0xB6,0x39,0xAF,0x66,0xE7,0x79,0xD1,0x43,0x68,0xFD,0x4E,0xB0,0x29,0x7C,0x35,0x1F,0x7C,0x75,0x08,0x0F,0xBB,0xCF,0x40,0x75,0xAF,0x5B,0xC2};
 BYTE hash2[SHA256_BLOCK_SIZE] = {0x80,0x45,0x1E,0xB1,0xC1,0x35,0x64,0x48,0xF4,0xD3,0x58,0xE0,0x57,0xD2,0xAF,0x4F,0x05,0xC8,0x77,0x5A,0xE6,0x32,0x89,0xDA,0x25,0xFF,0xE8,0xE1,0xE5,0x2B,0xCF,0xE0};
 BYTE hash3[SHA256_BLOCK_SIZE] = {0x3D,0x45,0x72,0x01,0x15,0xCA,0xCE,0x87,0x2D,0x0C,0xD7,0x3A,0x44,0xE4,0xD6,0x94,0x99,0x5D,0x11,0xF7,0x6F,0x3A,0xBB,0x52,0x74,0x3F,0xE9,0x71,0xE2,0x1C,0x65,0xA9};
 BYTE hash4[SHA256_BLOCK_SIZE] = {0x43,0x41,0x44,0x5C,0xC6,0xB5,0x9A,0x5F,0x9C,0x04,0xB1,0x91,0x27,0x21,0x74,0x46,0xBB,0x5E,0x33,0x8B,0x18,0x03,0xA7,0x24,0x3A,0x2E,0xF9,0x8C,0x16,0xAB,0x01,0xC1};
