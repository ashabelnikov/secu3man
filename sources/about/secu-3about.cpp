...
*/ 
 ...
 BYTE hash1[32] = {0x91,0x36,0x9D,0xCF,0x07,0x7C,0xEC,0x8F,0x04,0x19,0xAB,0xF9,0x43,0x49,0x6A,0xFE,0x61,0x9C,0xB7,0xDC,0xA8,0xF3,0x07,0x2B,0x7E,0x1B,0xF8,0x8C,0x1F,0x0A,0x63,0xE8}; //ru
 BYTE hash2[32] = {0x27,0x58,0x8B,0xCE,0x03,0x96,0x52,0xF7,0x9A,0xEC,0x4B,0xB2,0xC7,0xE9,0xF9,0x4A,0xA6,0xCF,0xA4,0xF1,0xB5,0x74,0x74,0x64,0x2B,0x4B,0xCB,0xAA,0x41,0xCF,0xDB,0x7B}; //en
...
bool ABOUT_API CheckAbout(void)
{
 ...
 BYTE hash1[32] = {0x18,0xF5,0x91,0x70,0xC7,0xE6,0xBA,0x0F,0x4D,0x52,0xA4,0x35,0xEC,0x49,0x06,0x7F,0x68,0x1A,0x5B,0x8E,0xB7,0x51,0x94,0xB5,0xC4,0x2E,0xD3,0xD1,0x85,0xBC,0xF1,0x0C};
 BYTE digest[SHA256_BLOCK_SIZE];
 Sha256 sha;
 sha.init();
 sha.update((BYTE*)str.c_str(), str.size());
...
{//hashes for 5.0 version info
 ...
 BYTE hash3[SHA256_BLOCK_SIZE] = {0x3D,0x4A,0xB9,0x37,0x34,0x3E,0xF3,0x4D,0x1A,0x1C,0x2F,0xF0,0xE6,0xCF,0xB4,0x3D,0xD3,0x6A,0x07,0x43,0xDC,0x50,0x48,0x7D,0xC1,0xB4,0x8F,0x14,0x87,0x0C,0x9C,0xEC};
 BYTE hash4[SHA256_BLOCK_SIZE] = {0xB2,0x2E,0x51,0x76,0x06,0x68,0x33,0x7C,0xF9,0xB0,0x30,0xAC,0x46,0x88,0x2F,0x0A,0xB9,0x12,0x2D,0x48,0x1D,0x79,0x8A,0xBA,0x39,0x87,0xB6,0x54,0x72,0xD9,0x5E,0x10};
