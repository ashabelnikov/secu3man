...
BOOL CSeptabsPanel::OnInitDialog()
{
 ...
 {
  m_calc_dwell_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP200), MAKEINTRESOURCE(IDB_CALC_DOWN200), 
                               MAKEINTRESOURCE(IDB_CALC_FOCUSED200), MAKEINTRESOURCE(IDB_CALC_DISABLED200));
  m_edit_cesettings_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CES_UP200), MAKEINTRESOURCE(IDB_CES_DOWN200), 
                               MAKEINTRESOURCE(IDB_CES_FOCUSED200), MAKEINTRESOURCE(IDB_CES_DISABLED200));
  m_rpm_grid_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_GRID_UP200), MAKEINTRESOURCE(IDB_GRID_DOWN200), 
                               MAKEINTRESOURCE(IDB_GRID_FOCUSED200), MAKEINTRESOURCE(IDB_GRID_DISABLED200));
  m_fw_consts_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CONST_UP200), MAKEINTRESOURCE(IDB_CONST_DOWN200), 
                               MAKEINTRESOURCE(IDB_CONST_FOCUSED200), MAKEINTRESOURCE(IDB_CONST_DISABLED200));
 }
 else if (dpi >= 144)  //144 to 192 DPI
 {
  m_calc_dwell_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP150), MAKEINTRESOURCE(IDB_CALC_DOWN150), 
                               MAKEINTRESOURCE(IDB_CALC_FOCUSED150), MAKEINTRESOURCE(IDB_CALC_DISABLED150));
  m_edit_cesettings_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CES_UP150), MAKEINTRESOURCE(IDB_CES_DOWN150), 
                               MAKEINTRESOURCE(IDB_CES_FOCUSED150), MAKEINTRESOURCE(IDB_CES_DISABLED150));
  m_rpm_grid_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_GRID_UP150), MAKEINTRESOURCE(IDB_GRID_DOWN150), 
                               MAKEINTRESOURCE(IDB_GRID_FOCUSED150), MAKEINTRESOURCE(IDB_GRID_DISABLED150));
  m_fw_consts_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CONST_UP150), MAKEINTRESOURCE(IDB_CONST_DOWN150), 
                               MAKEINTRESOURCE(IDB_CONST_FOCUSED150), MAKEINTRESOURCE(IDB_CONST_DISABLED150));
 }
 else //below 144 DPI
 {
