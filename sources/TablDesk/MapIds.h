...
enum EMapTypes
{
 ...
 TYPE_MAP_GME_IGN_WND   = 64, //pseudo map, grid mode editing window for ignition maps
 TYPE_MAP_GME_INJ_WND   = 65, //pseudo map, grid mode editing window for injection maps
