...
enum EMapTypes
{
 ...
 TYPE_MAP_GME_IGN_WND   = 55, //pseudo map, grid mode editing window for ignition maps
 TYPE_MAP_GME_INJ_WND   = 56, //pseudo map, grid mode editing window for injection maps
