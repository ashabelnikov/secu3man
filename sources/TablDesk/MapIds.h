...
enum EMapTypes
{
 ...
 TYPE_MAP_INJ_AEMAP     = 34, //must be = 34
 TYPE_MAP_INJ_THRASS    = 35, //must be = 35

 //separate maps
 TYPE_MAP_ATTENUATOR    = 36, //
 TYPE_MAP_DWELLCNTRL    = 37, //
 TYPE_MAP_CTS_CURVE     = 38, //
 TYPE_MAP_ATS_CURVE     = 39, //
 TYPE_MAP_ATS_CORR      = 40, //
 TYPE_MAP_GASDOSE       = 41, //
 TYPE_MAP_BAROCORR      = 42, //
 TYPE_MAP_MANIGNTIM     = 43, //
 TYPE_MAP_TMP2_CURVE    = 44, //
 TYPE_MAP_CRKCLT_CORR   = 45, //
 TYPE_MAP_EH_PAUSE      = 46, //
 TYPE_MAP_CRANKING_THRD = 47, //
 TYPE_MAP_CRANKING_TIME = 48, //
 TYPE_MAP_SMAPABAN_THRD = 49, //
 TYPE_MAP_KNOCK_ZONE    = 50, //
 TYPE_MAP_GRTS_CURVE    = 51, //
 TYPE_MAP_GRHEAT_DUTY   = 52, //
 TYPE_MAP_PWMIAC_UCOEF  = 53, //
 TYPE_MAP_AFTSTR_STRK0  = 54, //
 TYPE_MAP_AFTSTR_STRK1  = 55, //
 TYPE_MAP_GRVDELAY      = 56, //
 TYPE_MAP_FTLS_CURVE    = 57, //
 TYPE_MAP_EGTS_CURVE    = 58, //
 TYPE_MAP_OPS_CURVE     = 59, //
 TYPE_MAP_MANINJPWC     = 60, //
 TYPE_MAP_MAF_CURVE     = 61, //
 TYPE_MAP_FTLSCOR       = 62, //
 TYPE_MAP_LAMBDA_ZONE   = 63, //
 TYPE_MAP_FTS_CURVE     = 64, //
 TYPE_MAP_FUELDENS_CORR = 65, //

 TYPE_MAP_GME_IGN_WND   = 66, //pseudo map, grid mode editing window for ignition maps
 TYPE_MAP_GME_INJ_WND   = 67, //pseudo map, grid mode editing window for injection maps
