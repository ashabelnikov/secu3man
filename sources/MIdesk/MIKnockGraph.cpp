...
{
 MeasInstrBase::Append(i_values->knock_k, 0, 0, i_revdir);
}
...
void CMIKnockGraph::Append(const SECU3IO::SensorDat* i_values, bool i_revdir /*= false*/)
{
 MeasInstrBase::Append(i_values->knock_k, i_revdir);
}
