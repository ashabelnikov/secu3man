...
void CMIMaf::Create(CWnd* pParent)
{
 ...
 m_meter.SetTitle(MLL::LoadString(IDS_MI_MAF_TITLE));
 m_meter.SetColor(meter_value,RGB(10,80,255));
 m_meter.SetColor(meter_bground, GetSysColor(COLOR_BTNFACE));
 m_meter.SetColor(meter_labels, GDIHelpers::InvColor(GetSysColor(COLOR_BTNFACE)));
 m_meter.SetUnit(MLL::LoadString(IDS_MI_MAF_UNIT));
 m_meter.SetTickNumber(20);
 m_meter.AddAlertZone(0,100,RGB(130,130,180));
 m_meter.AddAlertZone(100,300,RGB(120,200,120));
 m_meter.AddAlertZone(300,500,RGB(200,200,120));
 m_meter.AddAlertZone(500,600,RGB(200,120,120));
 m_meter.SetNeedleValue(0.0);
 m_meter.Update();
}

void CMIMaf::SetLimits(float loLimit, float upLimit)
{
...
void CMIMafGraph::Create(CWnd* pParent)
{
 ...
 m_scope.SetUnitY(MLL::GetString(IDS_MI_MAFGRAPH_V_UNIT));
