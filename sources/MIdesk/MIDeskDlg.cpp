...
BEGIN_MESSAGE_MAP(CMIDeskDlg, Super)
 ...
 ON_COMMAND_RANGE(IDM_MI_IND_GAS_V, IDM_MI_IND_AUTO_I, OnIndAddIndicator)
 ON_UPDATE_COMMAND_UI_RANGE(IDM_MI_IND_GAS_V, IDM_MI_IND_AUTO_I, OnUpdateIndAddIndicator)
