...
BEGIN_MESSAGE_MAP(CLambdaPageDlg, Super)
 ...
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_CRKHEAT_CHECK,OnUpdateControls)
 ...
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_HEATING_GROUP,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TIME_COLD_SPIN,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TIME_COLD_CAPTION,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TIME_COLD_UNIT,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TIME_HOT_SPIN,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TIME_HOT_CAPTION,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TIME_HOT_UNIT,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TEMPER_THRD_SPIN,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TEMPER_THRD_CAPTION,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_TEMPER_THRD_UNIT,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_HEATING_ACT_SPIN,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_HEATING_ACT_CAPTION,OnUpdateControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_LAMBDA_EH_HEATING_ACT_UNIT,OnUpdateControls)
...
void CLambdaPageDlg::DoDataExchange(CDataExchange* pDX)
{
 ...
 DDX_Control(pDX,IDC_PD_LAMBDA_CRKHEAT_CHECK, m_crkheat_check);
