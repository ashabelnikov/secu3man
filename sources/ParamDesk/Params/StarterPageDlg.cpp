...
BOOL CStarterPageDlg::OnInitDialog()
{
 ...
 m_smap_abandon_rpm_spin.SetRangeAndDelta(40,2000,10);
 m_smap_abandon_rpm_edit.SetRange(40, 2000);

 m_starter_off_rpm_edit.SetLimitText(4);
 m_starter_off_rpm_spin.SetBuddy(&m_starter_off_rpm_edit);
 m_starter_off_rpm_spin.SetRangeAndDelta(40,2000,10);
 m_starter_off_rpm_edit.SetRange(40, 2000);
