...
BEGIN_MESSAGE_MAP(CStarterPageDlg, Super)
 ...
 ON_EN_CHANGE(IDC_PD_STARTER_CRANKTORUNTIME1_EDIT, OnChangeData)
 ...
 ON_UPDATE_COMMAND_UI(IDC_PD_STARTER_CRANKTORUNTIME1_SPIN,OnUpdateFuelInjectionControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_STARTER_CRANKTORUNTIME1_CAPTION,OnUpdateFuelInjectionControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_STARTER_CRANKTORUNTIME1_UNIT,OnUpdateFuelInjectionControls)
 ON_UPDATE_COMMAND_UI(IDC_PD_STARTER_CRANKTORUNTIME1_EDIT,OnUpdateFuelInjectionControls)
...
, m_cranktoruntime1_edit(CEditEx::MODE_FLOAT, true)
...
, mp_scr(new CWndScroller)
{
 ...
 m_params.inj_cranktorun_time1 = 3.00f;
...
void CStarterPageDlg::DoDataExchange(CDataExchange* pDX)
{
 ...
 DDX_Control(pDX, IDC_PD_STARTER_CRANKTORUNTIME1_EDIT, m_cranktoruntime1_edit);
 DDX_Control(pDX, IDC_PD_STARTER_CRANKTORUNTIME1_SPIN, m_cranktoruntime1_spin);
 ...
 m_cranktoruntime1_edit.DDX_Value(pDX, IDC_PD_STARTER_CRANKTORUNTIME1_EDIT, m_params.inj_cranktorun_time1);
...
BOOL CStarterPageDlg::OnInitDialog()
{
 ...
 m_cranktoruntime1_edit.SetLimitText(5);
 m_cranktoruntime1_spin.SetBuddy(&m_cranktoruntime1_edit);
 m_cranktoruntime1_edit.SetDecimalPlaces(2);
 m_cranktoruntime1_spin.SetRangeAndDelta(0.10f,99.00f, 0.01f);
 m_cranktoruntime1_edit.SetRange(0.10f, 99.00f);
 ...
 VERIFY(mp_ttc->AddWindow(&m_cranktoruntime1_edit, MLL::GetString(IDS_PD_STARTER_CRANKTORUNTIME2_EDIT_TT)));
 VERIFY(mp_ttc->AddWindow(&m_cranktoruntime1_spin, MLL::GetString(IDS_PD_STARTER_CRANKTORUNTIME2_EDIT_TT)));
