...
const UINT IOCaptionEnd3I = IDC_IO_REMAPPING3I_ADD_I5_CAPTION;
...
const UINT IOComboboxEnd3I = IDC_IO_REMAPPING3I_ADD_I5_COMBOBOX;
...
const UINT IOCheckboxEnd3I = IDC_IO_REMAPPING3I_ADD_I5_CHECKBOX;
...
const UINT IOTTStrEnd3I = IDS_IO_REMAPPING3I_ADD_I5_TT;
...
void CIORemappingDlg::_UpdateScrlViewSize(void)
{
 DPIAware da;
 if (mp_scr.get())
  mp_scr->SetViewSize(0, m_enable_secu3t_features ? da.ScaleY(450) : da.ScaleY(770));
}
