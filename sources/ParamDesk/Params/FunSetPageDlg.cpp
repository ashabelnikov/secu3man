...
BOOL CFunSetPageDlg::OnInitDialog()
{
 ...
 {
  m_calc_map_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP200), MAKEINTRESOURCE(IDB_CALC_DOWN200), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED200), MAKEINTRESOURCE(IDB_CALC_DISABLED200));
  m_calc_map2_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP200), MAKEINTRESOURCE(IDB_CALC_DOWN200), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED200), MAKEINTRESOURCE(IDB_CALC_DISABLED200));
  m_calc_gps_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP200), MAKEINTRESOURCE(IDB_CALC_DOWN200), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED200), MAKEINTRESOURCE(IDB_CALC_DISABLED200));
  m_calc_fps_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP200), MAKEINTRESOURCE(IDB_CALC_DOWN200), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED200), MAKEINTRESOURCE(IDB_CALC_DISABLED200));
  m_calc_tps_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP200), MAKEINTRESOURCE(IDB_CALC_DOWN200), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED200), MAKEINTRESOURCE(IDB_CALC_DISABLED200));
  m_calc_apps1_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP200), MAKEINTRESOURCE(IDB_CALC_DOWN200),
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED200), MAKEINTRESOURCE(IDB_CALC_DISABLED200));
 }
 else if (dpi >= 144)  //144 to 192 DPI
 {
  m_calc_map_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP150), MAKEINTRESOURCE(IDB_CALC_DOWN150), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED150), MAKEINTRESOURCE(IDB_CALC_DISABLED150));
  m_calc_map2_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP150), MAKEINTRESOURCE(IDB_CALC_DOWN150), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED150), MAKEINTRESOURCE(IDB_CALC_DISABLED150));
  m_calc_gps_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP150), MAKEINTRESOURCE(IDB_CALC_DOWN150), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED150), MAKEINTRESOURCE(IDB_CALC_DISABLED150));
  m_calc_fps_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP150), MAKEINTRESOURCE(IDB_CALC_DOWN150), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED150), MAKEINTRESOURCE(IDB_CALC_DISABLED150));
  m_calc_tps_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP150), MAKEINTRESOURCE(IDB_CALC_DOWN150), 
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED150), MAKEINTRESOURCE(IDB_CALC_DISABLED150));
  m_calc_apps1_btn.LoadBitmaps(MAKEINTRESOURCE(IDB_CALC_UP150), MAKEINTRESOURCE(IDB_CALC_DOWN150),
                            MAKEINTRESOURCE(IDB_CALC_FOCUSED150), MAKEINTRESOURCE(IDB_CALC_DISABLED150));
 }
 else //below 144 DPI
 {
