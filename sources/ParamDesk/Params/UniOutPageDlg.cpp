...
, mp_scr(new CWndScroller)
{
 ...
 m_lf_str.insert(std::make_pair(SECU3IO::UNIOUT_LF_NONE, MLL::GetString(IDS_UNIOUT_LF_NONE)));
                                 ...
                                 //i_textlim, i_decplaces, i_min, i_max, i_delta, i_defval_on, i_defval_off, i_condstr, i_sign
 ...
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_AI5, CondFmt(4, 2, .0f, 5.0f, 0.01f, 2.5f, 2.48f, MLL::GetString(IDS_UNIOUT_COND_AI5), false)));
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_AI6, CondFmt(4, 2, .0f, 5.0f, 0.01f, 2.5f, 2.48f, MLL::GetString(IDS_UNIOUT_COND_AI6), false)));
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_AI7, CondFmt(4, 2, .0f, 5.0f, 0.01f, 2.5f, 2.48f, MLL::GetString(IDS_UNIOUT_COND_AI7), false)));
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_AI8, CondFmt(4, 2, .0f, 5.0f, 0.01f, 2.5f, 2.48f, MLL::GetString(IDS_UNIOUT_COND_AI8), false)));
 ...
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_LPTMR, CondFmt(6, 2, .0f, 600.0f, 0.01f, 1.0f, 5.0f, MLL::GetString(IDS_UNIOUT_COND_LPTMR), false)));
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_GRTS,  CondFmt(6, 2, -40.0f, 300.0f, 0.25f, 55.0f, 50.0f, MLL::GetString(IDS_UNIOUT_COND_GRTS), true)));
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_MAP2,  CondFmt(5, 2, 0.25f, 500.0f, 0.25f, 95.0f, 90.0f, MLL::GetString(IDS_UNIOUT_COND_MAP2), false)));
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_TMP2, CondFmt(5, 2, -40.0f, 300.0f, 0.25f, 55.0f, 50.0f, MLL::GetString(IDS_UNIOUT_COND_TMP2), true)));
 ...
 m_condFmt.insert(std::make_pair(SECU3IO::UNIOUT_COND_LOAD,  CondFmt(6, 2, 0.25f, 500.0f, 0.25f, 95.0f, 90.0f, MLL::GetString(IDS_UNIOUT_COND_LOAD), false)));
}
