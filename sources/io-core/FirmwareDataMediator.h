...
class IOCORE_API CFirmwareDataMediator
{
 ...
 ~CFirmwareDataMediator();
  ...
  enum IOPid
  {
   ...
   IOP_FL_PUMP    =  25,     // FL_PUMP     (output)
   IOP_HALL_OUT   =  26,     // HALL_OUT    (output)
   IOP_STROBE     =  27,     // STROBE      (output)
   IOP_PWRRELAY   =  28,     // PWRRELAY    (output)
   IOP_IGN        =  29,     // IGN         (input)
   IOP_IGN_OUT7   =  30,     // IGN_OUT7    (output)
   IOP_IGN_OUT8   =  31,     // IGN_OUT8    (output)
   IOP_BC_INPUT   =  32,     // BC_INPUT    (input)
   IOP_SM_DIR     =  33,     // SM_DIR      (output)
   IOP_SM_STP     =  34,     // SM_STP      (output)
   IOP_MAPSEL0    =  35,     // MAPSEL0     (input)
   IOP_SPDSENS    =  36,     // SPD_SENS    (input)
   IOP_INTK_HEAT  =  37,     // INTK_HEAT   (output)
   IOP_LAMBDA     =  38,     // LAMBDA      (input)
   IOP_AIR_TEMP   =  39,     // AIR_TEMP    (input)
   IOP_UNI_OUT0   =  40,     // UNI_OUT0    (output)
   IOP_UNI_OUT1   =  41,     // UNI_OUT1    (output)
   IOP_UNI_OUT2   =  42,     // UNI_OUT2    (output)
   IOP_INJ_OUT0   =  43,     // INJ_OUT0    (output)
   IOP_INJ_OUT1   =  44,     // INJ_OUT1    (output)
   IOP_INJ_OUT2   =  45,     // INJ_OUT2    (output)
   IOP_INJ_OUT3   =  46,     // INJ_OUT3    (output)
// IOP_RESERVED11 =  47,     // Reserved    ()
// IOP_RESERVED12 =  48,     // Reserved    ()
// IOP_RESERVED13 =  49,     // Reserved    ()
// IOP_RESERVED14 =  50,     // Reserved    ()
// IOP_RESERVED15 =  51,     // Reserved    ()
// IOP_RESERVED16 =  52,     // Reserved    ()
// IOP_RESERVED17 =  53,     // Reserved    ()
// IOP_RESERVED18 =  54,     // Reserved    ()
// IOP_RESERVED19 =  55,     // Reserved    ()
