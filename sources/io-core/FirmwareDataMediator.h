...
class IOCORE_API CFirmwareDataMediator : public ParamsIO
{
 ...
 ~CFirmwareDataMediator();
  ...
  enum IOPid
  {
   ...
   IOP3I_IE         =  64,     // IE        (output)
   IOP3I_FE         =  65,     // FE        (output)
   IOP3I_BC_INPUT   =  66,     // BC_INPUT  (input)
   IOP3I_MAPSEL0    =  67,     // MAPSEL0   (input)
   IOP3I_SPDSENS    =  68,     // SPD_SENS  (input)
   IOP3I_LAMBDA     =  69,     // LAMBDA    (input)
   IOP3I_AIR_TEMP   =  70,     // AIR_TEMP  (input)
   IOP3I_CAN_CS     =  71,     // CAN_CS    (output)
   IOP3I_INJ_O6     =  72,     // INJ_O6    (output)
   IOP3I_INJ_O7     =  73,     // INJ_O7    (output)
   IOP3I_INJ_O8     =  74,     // INJ_O8    (output)
   IOP3I_IGNTIM     =  75,     // IGNTIM    (input)
   IOP3I_MAP2       =  76,     // MAP2      (input)
   IOP3I_TMP2       =  77,     // TEMP2     (input)
   IOP3I_PWM1       =  78,     // PWM1      (output)
   IOP3I_PWM2       =  79,     // PWM2      (output)
   IOP3I_FL_CONS    =  80,     // FL_CONS   (output)
   IOP3I_AUTO_I     =  81,     // AUTO_I    (input)
// IOP3I_RESERVED16 =  82,     // Reserved    ()
// IOP3I_RESERVED17 =  83,     // Reserved    ()
// IOP3I_RESERVED18 =  84,     // Reserved    ()
...
// IOP3I_RESERVED25 =  91,     // Reserved    ()
   IOP3I_COUNT      =  82,     //DON'T forget to update this value
   ...
   IOP_INJ_OUT1   =  67,     // INJ_OUT1    (output)
   IOP_INJ_OUT2   =  68,     // INJ_OUT2    (output)
   IOP_INJ_OUT3   =  69,     // INJ_OUT3    (output)
   IOP_INJ_OUT4   =  70,     // INJ_OUT4    (output)
   IOP_IAC_PWM    =  71,     // IAC_PWM     (output)
   IOP_GD_DIR     =  72,     // GD_DIR      (output)
   IOP_GD_STP     =  73,     // GD_STP      (output)
   IOP_GD_PWM     =  74,     // GD_PWM      (output)
   IOP_INJ_OUT5   =  75,     // INJ_OUT5    (output)
   IOP_INJ_OUT6   =  76,     // INJ_OUT6    (output)
   IOP_COND_I     =  77,     // COND_I      (input)
   IOP_O2SH_O     =  78,     // O2SH_O      (output)
   IOP_PWM1       =  79,     // PWM1        (output)
   IOP_PWM2       =  80,     // PWM2        (output)
   IOP_FL_CONS    =  81,     // FL_CONS     (output)
   IOP_AUTO_I     =  82,     // AUTO_I      (input)
// IOP_RESERVED30 =  83,     // Reserved    ()
// IOP_RESERVED30 =  84,     // Reserved    ()
// IOP_RESERVED30 =  85,     // Reserved    ()
...
// IOP_RESERVED30 =  91,     // Reserved    ()
   IOP_COUNT      =  83,     // Number of plugs used in I/O remapping
   IOP_NA         =  255     //
  };
...
// IOS_RESERVED18   =  48,     // Reserved    ()
  ...
  enum IORemVer
  {
   ...
   IOV_V31 = 0x31            //V3.1  New plugs were added (PWM1, PWM2, FL_CONS, AUTO_I)
  };
