...
class IOCORE_API CComPort
{
 public:   //public functions
  ...
  bool   Initialize(DWORD, BYTE, BYTE); //инициализаци€ порта
  ...
  //да, да - именно float т.к число может оказатьс€ нецелым и потер€ знаков после зап€той будет €вл€тс€
  //причиной ошибки в расчете времени необходимого дл€ N байт.
 ...
 private:
  ...
  _TSTRING      m_sComPort;     //им€ файла - порта
  ...
  UINT          m_rcv_err_num;  //хранит кол-во ошибок чтени€ из порта
};
