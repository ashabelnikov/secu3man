...
const float CNumericConv::neg_p10[] = {1.0f, 1e-1f, 1e-2f, 1e-3f, 1e-4f, 1e-5f, 1e-6f, 1e-7f, 1e-8f, 1e-9f, 1e-10f, 1e-11f, 1e-12f};
const float CNumericConv::pos_p10[] = {1.0f, 1e+1f, 1e+2f, 1e+3f, 1e+4f, 1e+5f, 1e+6f, 1e+7f, 1e+8f, 1e+9f, 1e+10f, 1e+11f, 1e+12f};
unsigned int CNumericConv::int_p10[INTP10_SIZE] = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
const float CNumericConv::scales[13] = {1.0f, 1e-1f, 1e-2f, 1e-3f, 1e-4f, 1e-5f, 1e-6f, 1e-7f, 1e-8f, 1e-9f, 1e-10f, 1e-11f, 1e-12f};

//lokup table used to speed up time to string conversion
const char CNumericConv::IntToStr[100][3] = 
    {
