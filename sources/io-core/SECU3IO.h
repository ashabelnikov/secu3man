...
namespace SECU3IO
{
 ...
 struct SensorDat
 {
  int rpm;                              //частота вращения коленвала (усредненная)
 ...
 struct StartrPar
 {
  ...
  float inj_cranktorun_time;            //sec. -30
  float inj_cranktorun_time1;           //sec. +70
 ...
 struct SecurPar
 {
  ...
  int  bt_type;                         //Bluetooth type: 0 - BC417, 1 - BK3231, 2 - BK3231S (JDY-31), 3 - BC352(HC-05), 4 - BK3432, 5 - BK3431S
 ...
 struct InjctrPar
 {
  ...
  bool inj_fsafterstart;              //Full sequential after start
