...
enum EFWDFlags
{
 ...
 FLAG_GRTSCURVE_MAP = 43,    //separate
 FLAG_GRHEAT_MAP    = 44,    //separate
 FLAG_IACUCOEF_MAP  = 45,    //separate
 FLAG_AFTSTRK0_MAP  = 46,    //separate
 FLAG_AFTSTRK1_MAP  = 47,    //separate

 FLAG_NR_OF_FLAGS   = 48,    //total number of flags
