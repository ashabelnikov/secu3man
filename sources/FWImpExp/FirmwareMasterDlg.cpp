...
BEGIN_MESSAGE_MAP(CFirmwareMasterDlg, Super)
 ...
 ON_COMMAND_RANGE(IDC_FWM_DWELL_CHECK, IDC_FWM_ODDF_CHECK, OnFwmCheck)
...
void CFirmwareMasterDlg::DoDataExchange(CDataExchange* pDX)
{
 ...
 DDX_Control(pDX, IDC_FWM_ODDF_CHECK, m_fwm_checks[FWM_ODDF]);
 ...
 DDX_Check_bool(pDX, IDC_FWM_ODDF_CHECK, m_fwm_flags[FWM_ODDF]);
...
BOOL CFirmwareMasterDlg::OnInitDialog()
{
 ...
 for (UINT ids = IDS_FWM_DWELL_CHECK_TT; ids <= IDS_FWM_ODDF_CHECK_TT; ids++, idc++)
