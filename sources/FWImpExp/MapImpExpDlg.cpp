...
, m_initialized(false)
{
 ...
 m_fwd_flags[FLAG_VEI_MAP] = FALSE;
 ...
 m_fwd_flags[FLAG_AEMAP_MAP] = FALSE;
 m_fwd_flags[FLAG_THRASS_MAP] = FALSE;
 //separate maps
 ...
 m_fwd_flags[FLAG_FTSCURVE_MAP] = FALSE;
 m_fwd_flags[FLAG_FUELDENSC_MAP] = FALSE;
 m_fwd_flags[FLAG_INJNONLINP_MAP] = FALSE;
 m_fwd_flags[FLAG_INJNONLING_MAP] = FALSE;
 m_fwd_flags[FLAG_XTAU_XFACC_MAP] = FALSE;
 m_fwd_flags[FLAG_XTAU_XFDEC_MAP] = FALSE;
 m_fwd_flags[FLAG_XTAU_TFACC_MAP] = FALSE;
 m_fwd_flags[FLAG_XTAU_TFDEC_MAP] = FALSE;
 m_fwd_flags[FLAG_EGO_DELAY_MAP] = FALSE;
 m_fwd_flags[FLAG_WU_AFR0] = FALSE;
 m_fwd_flags[FLAG_WU_AFR1] = FALSE;
 m_fwd_flags[FLAG_ETC_SPRPREL] = FALSE;
 m_fwd_flags[FLAG_ETC_ACCEERR] = FALSE;
 m_fwd_flags[FLAG_ETC_THROPOS] = FALSE;
 m_fwd_flags[FLAG_OTSCURVE_MAP] = FALSE;
}
...
void CMapImpExpDlg::DoDataExchange(CDataExchange* pDX)
{
 ...
 DDX_Check(pDX, IDC_MAP_IMPEXP_VEIMAP_FLAG, m_fwd_flags[FLAG_VEI_MAP]);
 ...
 DDX_Check(pDX, IDC_MAP_IMPEXP_AEMAPMAP_FLAG, m_fwd_flags[FLAG_AEMAP_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_THRASS_FLAG, m_fwd_flags[FLAG_THRASS_MAP]);
 //separate
 ...
 DDX_Check(pDX, IDC_MAP_IMPEXP_FTSCURVE_FLAG, m_fwd_flags[FLAG_FTSCURVE_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_FUELDENSC_FLAG, m_fwd_flags[FLAG_FUELDENSC_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_INJNONLINP_FLAG, m_fwd_flags[FLAG_INJNONLINP_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_INJNONLING_FLAG, m_fwd_flags[FLAG_INJNONLING_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_XTAU_XFACC_FLAG, m_fwd_flags[FLAG_XTAU_XFACC_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_XTAU_XFDEC_FLAG, m_fwd_flags[FLAG_XTAU_XFDEC_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_XTAU_TFACC_FLAG, m_fwd_flags[FLAG_XTAU_TFACC_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_XTAU_TFDEC_FLAG, m_fwd_flags[FLAG_XTAU_TFDEC_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_EGO_DELAY_FLAG, m_fwd_flags[FLAG_EGO_DELAY_MAP]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_WU_AFR0_FLAG, m_fwd_flags[FLAG_WU_AFR0]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_WU_AFR1_FLAG, m_fwd_flags[FLAG_WU_AFR1]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_ETC_SPRPREL_FLAG, m_fwd_flags[FLAG_ETC_SPRPREL]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_ETC_ACCEERR_FLAG, m_fwd_flags[FLAG_ETC_ACCEERR]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_ETC_THROPOS_FLAG, m_fwd_flags[FLAG_ETC_THROPOS]);
 DDX_Check(pDX, IDC_MAP_IMPEXP_OTSCURVE_FLAG, m_fwd_flags[FLAG_OTSCURVE_MAP]);
 //ignition
 ...
 DDX_Control(pDX, IDC_MAP_IMPEXP_VEIMAP_FLAG, m_fwd_flags_buttons[FLAG_VEI_MAP]);
 ...
 DDX_Control(pDX, IDC_MAP_IMPEXP_AEMAPMAP_FLAG, m_fwd_flags_buttons[FLAG_AEMAP_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_THRASS_FLAG, m_fwd_flags_buttons[FLAG_THRASS_MAP]);
 //separate
 ...
 DDX_Control(pDX, IDC_MAP_IMPEXP_FTSCURVE_FLAG, m_fwd_flags_buttons[FLAG_FTSCURVE_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_FUELDENSC_FLAG, m_fwd_flags_buttons[FLAG_FUELDENSC_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_INJNONLINP_FLAG, m_fwd_flags_buttons[FLAG_INJNONLINP_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_INJNONLING_FLAG, m_fwd_flags_buttons[FLAG_INJNONLING_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_XTAU_XFACC_FLAG, m_fwd_flags_buttons[FLAG_XTAU_XFACC_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_XTAU_XFDEC_FLAG, m_fwd_flags_buttons[FLAG_XTAU_XFDEC_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_XTAU_TFACC_FLAG, m_fwd_flags_buttons[FLAG_XTAU_TFACC_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_XTAU_TFDEC_FLAG, m_fwd_flags_buttons[FLAG_XTAU_TFDEC_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_EGO_DELAY_FLAG, m_fwd_flags_buttons[FLAG_EGO_DELAY_MAP]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_WU_AFR0_FLAG, m_fwd_flags_buttons[FLAG_WU_AFR0]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_WU_AFR1_FLAG, m_fwd_flags_buttons[FLAG_WU_AFR1]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_ETC_SPRPREL_FLAG, m_fwd_flags_buttons[FLAG_ETC_SPRPREL]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_ETC_ACCEERR_FLAG, m_fwd_flags_buttons[FLAG_ETC_ACCEERR]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_ETC_THROPOS_FLAG, m_fwd_flags_buttons[FLAG_ETC_THROPOS]);
 DDX_Control(pDX, IDC_MAP_IMPEXP_OTSCURVE_FLAG, m_fwd_flags_buttons[FLAG_OTSCURVE_MAP]);
...
void CMapImpExpDlg::EnableFWDFlag(EFWDFlags i_flag_type, bool i_enable)
{
 ...
 enable = ((m_fwd_flags_buttons[FLAG_ATTEN_MAP].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_DWLCNTR_MAP].IsWindowEnabled()) ||
           ...
           (m_fwd_flags_buttons[FLAG_FTSCURVE_MAP].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_FUELDENSC_MAP].IsWindowEnabled()) ||
           (m_fwd_flags_buttons[FLAG_INJNONLINP_MAP].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_INJNONLING_MAP].IsWindowEnabled()) ||
           (m_fwd_flags_buttons[FLAG_XTAU_XFACC_MAP].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_XTAU_XFDEC_MAP].IsWindowEnabled()) ||
           (m_fwd_flags_buttons[FLAG_XTAU_TFACC_MAP].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_XTAU_TFDEC_MAP].IsWindowEnabled()) ||
           (m_fwd_flags_buttons[FLAG_EGO_DELAY_MAP].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_WU_AFR0].IsWindowEnabled()) ||
           (m_fwd_flags_buttons[FLAG_WU_AFR1].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_ETC_SPRPREL].IsWindowEnabled()) ||
           (m_fwd_flags_buttons[FLAG_ETC_ACCEERR].IsWindowEnabled()) || (m_fwd_flags_buttons[FLAG_ETC_THROPOS].IsWindowEnabled()) ||
           (m_fwd_flags_buttons[FLAG_OTSCURVE_MAP].IsWindowEnabled()));
...
BOOL CMapImpExpDlg::OnInitDialog()
{
 ...
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_VEI_MAP], MLL::GetString(IDS_MAP_IMPEXP_STARTMAP_FLAG_TT)));
 ...
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_AEMAP_MAP], MLL::GetString(IDS_MAP_IMPEXP_STARTMAP_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_THRASS_MAP], MLL::GetString(IDS_MAP_IMPEXP_STARTMAP_FLAG_TT)));
 //separate
 ...
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_FTSCURVE_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_FUELDENSC_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_INJNONLINP_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_INJNONLING_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_XTAU_XFACC_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_XTAU_XFDEC_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_XTAU_TFACC_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_XTAU_TFDEC_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_EGO_DELAY_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_WU_AFR0], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_WU_AFR1], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_ETC_SPRPREL], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_ETC_ACCEERR], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_ETC_THROPOS], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
 VERIFY(mp_ttc->AddWindow(&m_fwd_flags_buttons[FLAG_OTSCURVE_MAP], MLL::GetString(IDS_MAP_IMPEXP_DWELLCNTRL_FLAG_TT)));
...
void CMapImpExpDlg::_UpdateScrlViewSize(void)
{
 DPIAware da;
 if (mp_scr.get())
  mp_scr->SetViewSize(da.ScaleX(475), da.ScaleY(740));
}
