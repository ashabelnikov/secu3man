...
void MPSZImportController::OnViewActivate(void)
{
 ...
 mp_view->SetFWDFlag(FLAG_VE2_MAP, false);
 mp_view->EnableFWDFlag(FLAG_VE2_MAP, false);
 mp_view->SetFWDFlag(FLAG_VEI_MAP, false);
 mp_view->EnableFWDFlag(FLAG_VEI_MAP, false);
 ...
 mp_view->EnableFWDFlag(FLAG_AEMAP_MAP, false);
 ...
 mp_view->SetFWDFlag(FLAG_IACMAT_MAP, false);
 mp_view->EnableFWDFlag(FLAG_IACMAT_MAP, false);
 mp_view->SetFWDFlag(FLAG_TPSZON_MAP, false);
 mp_view->EnableFWDFlag(FLAG_TPSZON_MAP, false);
 mp_view->SetFWDFlag(FLAG_CYLMULT_MAP, false);
 mp_view->EnableFWDFlag(FLAG_CYLMULT_MAP, false);
 mp_view->SetFWDFlag(FLAG_CYLADD_MAP, false);
 mp_view->EnableFWDFlag(FLAG_CYLADD_MAP, false);
 //separate
